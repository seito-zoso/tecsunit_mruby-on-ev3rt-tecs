...
extern const struct tag_nTECSInfo_tDescriptorTypeInfo_eTypeInfo_DES rDomainEV3_rTECSInfo_Descriptor_of_nTECSInfo_sRawEntryDescriptorInfoTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tDescriptorTypeInfo_eTypeInfo_DES rDomainEV3_rTECSInfo_Descriptor_of_nTECSInfo_sRawEntryDescriptorInfoTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tDescriptorTypeInfo_eTypeInfo_MT_,
