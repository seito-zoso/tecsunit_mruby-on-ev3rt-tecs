...
nTECSInfo_tFloatTypeInfo_INIB nTECSInfo_tFloatTypeInfo_INIB_tab[] = {
    /* cell: nTECSInfo_tFloatTypeInfo_CB_tab[0]:  float32_tTypeInfo id=1 */
    {
        ...
        "float32_t",                             /* name */
        3,                                       /* typeKind */
        sizeof(float32_t),                       /* size */
        false,                                   /* b_const */
        false,                                   /* b_volatile */
    },
    /* cell: nTECSInfo_tFloatTypeInfo_CB_tab[1]:  double64_tTypeInfo id=2 */
    {
        /* entry port #_EP_# */ 
        /* attribute(RO) */ 
        "double64_t",                            /* name */
...
extern const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rDomainEV3_rTECSInfo_double64_tTypeInfo_eTypeInfo_des;
const struct tag_nTECSInfo_tFloatTypeInfo_eTypeInfo_DES rDomainEV3_rTECSInfo_double64_tTypeInfo_eTypeInfo_des = {
    &nTECSInfo_tFloatTypeInfo_eTypeInfo_MT_,
    &nTECSInfo_tFloatTypeInfo_INIB_tab[1],      /* INIB 3 */
};
/* CB 初期化コード #_CIC_# */
void
