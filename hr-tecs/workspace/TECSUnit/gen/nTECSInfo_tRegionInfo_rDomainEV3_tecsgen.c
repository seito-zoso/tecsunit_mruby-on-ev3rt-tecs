...
extern struct tag_nTECSInfo_sCellInfo_VDES rDomainEV3_rTECSInfo_Target1CellInfo_eCellInfo_des;
extern struct tag_nTECSInfo_sCellInfo_VDES rDomainEV3_rTECSInfo_Target2CellInfo_eCellInfo_des;
extern struct tag_nTECSInfo_sCellInfo_VDES rDomainEV3_rTECSInfo_Target3CellInfo_eCellInfo_des;
...
/* 呼び口配列 #_CPA_# */
struct tag_nTECSInfo_sCellInfo_VDES * const rDomainEV3_rTECSInfo__LinkRootRegionInfo_cCellInfo[] = {
    &rDomainEV3_rTECSInfo_Target1CellInfo_eCellInfo_des,
    &rDomainEV3_rTECSInfo_Target2CellInfo_eCellInfo_des,
    &rDomainEV3_rTECSInfo_Target3CellInfo_eCellInfo_des,
};
...
nTECSInfo_tRegionInfo_INIB nTECSInfo_tRegionInfo_INIB_tab[] = {
    ...
    {
        /* call port (INIB) #_CP_# */ 
        rDomainEV3_rTECSInfo__LinkRootRegionInfo_cCellInfo, /* #_CCP3B_# */
    ...
    /* cell: nTECSInfo_tRegionInfo_CB_tab[1]:  rDomainEV3RegionInfo id=2 */
    {
        ...
        63,                                      /* length of cCellInfo (n_cCellInfo) #_CCP4_# */
