...
static STK_T _kernel_sstack_TSKID_tTask_rDomainEV3_EV3Task[COUNT_STK_T(STACK_SIZE)] __attribute__((section(".prsv_kernel"),nocommon));
static STK_T _kernel_sstack_TSKID_tTask_rDomainEV3_MrubyTask1[COUNT_STK_T(MRUBY_VM_STACK_SIZE)] __attribute__((section(".prsv_kernel"),nocommon));

static STK_T _kernel_ustack_BRICK_BTN_TSK[COUNT_STK_T(4096)] __attribute__((section(".ustack_BRICK_BTN_TSK"),nocommon));
static STK_T _kernel_ustack_APP_INIT_TASK[COUNT_STK_T(4096)] __attribute__((section(".ustack_APP_INIT_TASK"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ &_kernel_dominib_kernel, (TA_ACT), (intptr_t)(0), ((TASK)(tTask_start_task)), INT_PRIORITY(EV3_PLATFORM_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TSKID_tTask_rDomainEV3_EV3Task, 0, NULL, (TA_NULL), (tTask_start_exception), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }},
	{ &_kernel_dominib_kernel, (TA_ACT), (intptr_t)(1), ((TASK)(tTask_start_task)), INT_PRIORITY(EV3_MRUBY_VM_PRIORITY), ROUND_STK_T(MRUBY_VM_STACK_SIZE), _kernel_sstack_TSKID_tTask_rDomainEV3_MrubyTask1, 0, NULL, (TA_NULL), (tTask_start_exception), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }}
};
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, USBMSC_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, EV3RT_LOGTASK, APP_INIT_TASK, TSKID_tTask_rDomainEV3_EV3Task, TSKID_tTask_rDomainEV3_MrubyTask1
};
...
const uint_t _kernel_tnum_isr_queue = 15;

const ISR_ENTRY _kernel_isr_queue_list[15] = {
...
QUEUE _kernel_isr_queue_table[15];
...
STK_T _kernel_ustack_TOPPERS_DUMMY1[COUNT_STK_T(4096)] __attribute__((section(".ustack_TOPPERS_DUMMY1"),nocommon));
...
const FP _kernel_exch_tbl[TNUM_EXCH] = {
	...
	(FP)(ev3_prefetch_handler), /* 3 */
	(FP)(ev3_data_abort_handler), /* 4 */
