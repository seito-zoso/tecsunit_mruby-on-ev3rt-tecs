...
typedef struct tag_nMruby_tsKernel_Initializer_CB {
    int  dummy;
} nMruby_tsKernel_Initializer_CB;
/* シングルトンセル CB プロトタイプ宣言 #_MCPB_# */

/* セルタイプのIDX型 #_CTIX_# */
typedef int   nMruby_tsKernel_Initializer_IDX;
...
#define nMruby_tsKernel_Initializer_ID_BASE        (1)  /* ID のベース  #_NIDB_# */
#define nMruby_tsKernel_Initializer_N_CELL        (1)  /* セルの個数  #_NCEL_# */
...
/* セルCBを得るマクロ #_GCB_# */
#define nMruby_tsKernel_Initializer_GET_CELLCB(idx) ((void *)0)
#ifndef TECSFLOW
#else  /* TECSFLOW */
#endif /* TECSFLOW */
