...
typedef struct tag_nMruby_tsUltrasonicSensor_Initializer_CB {
    int  dummy;
} nMruby_tsUltrasonicSensor_Initializer_CB;
/* シングルトンセル CB プロトタイプ宣言 #_MCPB_# */

/* セルタイプのIDX型 #_CTIX_# */
typedef int   nMruby_tsUltrasonicSensor_Initializer_IDX;
...
/* セルCBを得るマクロ #_GCB_# */
#define nMruby_tsUltrasonicSensor_Initializer_GET_CELLCB(idx) ((void *)0)
#ifndef TECSFLOW
#else  /* TECSFLOW */
#endif /* TECSFLOW */
