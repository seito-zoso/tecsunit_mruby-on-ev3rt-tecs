...
struct tag_nTECSInfo_sCellInfo_VDES * const rDomainEV3_rTECSInfo_rDomainEV3RegionInfo_cCellInfo[] = {
    ...
    &rDomainEV3_rTECSInfo_rDomainEV3_Target1CellInfo_eCellInfo_des,
    &rDomainEV3_rTECSInfo_rDomainEV3_Target2CellInfo_eCellInfo_des,
    &rDomainEV3_rTECSInfo_rDomainEV3_Target3CellInfo_eCellInfo_des,
...
nTECSInfo_tRegionInfo_INIB nTECSInfo_tRegionInfo_INIB_tab[] = {
    ...
    /* cell: nTECSInfo_tRegionInfo_CB_tab[1]:  rDomainEV3RegionInfo id=2 */
    {
        ...
        64,                                      /* length of cCellInfo (n_cCellInfo) #_CCP4_# */
