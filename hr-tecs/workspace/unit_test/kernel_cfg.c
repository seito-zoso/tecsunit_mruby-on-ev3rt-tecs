...
static STK_T _kernel_sstack_TSKID_tTask_rDomainEV3_Task[COUNT_STK_T(MRUBY_VM_STACK_SIZE)] __attribute__((section(".prsv_kernel"),nocommon));
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ &_kernel_dominib_kernel, (TA_ACT), (intptr_t)(1), ((TASK)(tTask_start_task)), INT_PRIORITY(EV3_MRUBY_VM_PRIORITY), ROUND_STK_T(MRUBY_VM_STACK_SIZE), _kernel_sstack_TSKID_tTask_rDomainEV3_Task, 0, NULL, (TA_NULL), (tTask_start_exception), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }}
};
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, USBMSC_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, EV3RT_LOGTASK, APP_INIT_TASK, TSKID_tTask_rDomainEV3_EV3Task, TSKID_tTask_rDomainEV3_Task
};
